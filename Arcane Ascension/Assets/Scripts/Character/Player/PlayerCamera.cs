...
public class PlayerCamera : MonoBehaviour
{
    ...
    private void CameraControl()
    {
        ...
        cameraX -= input.Camera.y * player.Values.CameraSpeed *
            PlayerPrefs.GetFloat(PPrefsOptions.Mouse.ToString(), 1) * Time.fixedDeltaTime;
        cameraX = Mathf.Clamp(
        ...
        transform.Rotate(input.Camera.x * player.Values.CameraSpeed * 
            PlayerPrefs.GetFloat(PPrefsOptions.Mouse.ToString(), 1) * Time.fixedDeltaTime * Vector3.up);
    }
