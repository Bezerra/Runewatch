	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN , FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float3 Color = ( (Fresnel122_g1).rgb + (temp_output_9_0_g170).rgb );
...
/*ASEBEGIN
Version=18935
1920;204;1920;1019;673.7664;520.8093;1;True;False
...
ASEEND*/
//CHKSM=EEFA3F762606D6C99A3BE373BEB19FCFB0D8B576