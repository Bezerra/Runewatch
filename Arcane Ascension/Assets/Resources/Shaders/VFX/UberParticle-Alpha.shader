	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = (temp_output_9_0_g115).rgb;
				float Alpha = ( temp_output_9_0_g115.a * Dissolve31_g1 * Mask29_g1 * distanceDepth114_g1 );
...
ASEEND*/
//CHKSM=EE35E361CACA4FD0447C65951F3D48E7A77C0234