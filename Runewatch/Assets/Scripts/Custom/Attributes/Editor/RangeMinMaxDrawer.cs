...
internal class RangeMinMaxDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        var attr = attribute as RangeMinMax;
        ...
        if (attr.DataFields)
        {
            sliderPos.x += fieldWidth + spacing + 24;
            sliderPos.width -= (fieldWidth + spacing) * 4.3f;
        }
        ...
        if (attr.DataFields)
        {
            ...
            maxPos.x += maxPos.width - fieldWidth - 20;
            maxPos.width = fieldWidth + 20;
