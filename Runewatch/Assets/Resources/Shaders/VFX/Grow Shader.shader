...
Shader "D4/Particles/Grow Shader"
{
	Properties
	{
		...
		[ASEEnd]_PushPull("PushPull", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 texCoord10 = v.texcoord1.xyzw.xyz;
				texCoord10.xy = v.texcoord1.xyzw.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_17_0 = ( texCoord10.z - texCoord10.x );
				float temp_output_15_0 = saturate( temp_output_17_0 );
				
				o.ase_color = v.ase_color;
				o.ase_texcoord7.xy = v.texcoord.xy;
				o.ase_texcoord8.xyz = v.texcoord1.xyzw.xyz;
				...
				#endif
				float3 vertexValue = ( ( temp_output_15_0 * v.ase_normal ) * _PushPull );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
						 ...
						 ) : SV_Target
			{
				...
				float4 temp_output_9_0_g1 = ( IN.ase_color * _Color * tex2D( _MainTexture, uv_MainTexture ) );
				
				float3 texCoord10 = IN.ase_texcoord8.xyz;
				texCoord10.xy = IN.ase_texcoord8.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_17_0 = ( texCoord10.z - texCoord10.x );
				float temp_output_15_0 = saturate( temp_output_17_0 );
				
				float3 Albedo = (temp_output_9_0_g1).rgb;
				...
				float Occlusion = 1;
				float Alpha = ( 1.0 - temp_output_15_0 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float3 texCoord10 = v.ase_texcoord1.xyz;
				texCoord10.xy = v.ase_texcoord1.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_17_0 = ( texCoord10.z - texCoord10.x );
				float temp_output_15_0 = saturate( temp_output_17_0 );
						 ...
						 ) : SV_TARGET
			{
				...
				float3 texCoord10 = IN.ase_texcoord2.xyz;
				texCoord10.xy = IN.ase_texcoord2.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_17_0 = ( texCoord10.z - texCoord10.x );
				float temp_output_15_0 = saturate( temp_output_17_0 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 texCoord10 = v.texcoord1.xyz;
				texCoord10.xy = v.texcoord1.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_17_0 = ( texCoord10.z - texCoord10.x );
				float temp_output_15_0 = saturate( temp_output_17_0 );
				
				o.ase_color = v.ase_color;
				o.ase_texcoord2.xy = v.ase_texcoord.xy;
				o.ase_texcoord3.xyz = v.texcoord1.xyz;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 texCoord10 = IN.ase_texcoord3.xyz;
				texCoord10.xy = IN.ase_texcoord3.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_17_0 = ( texCoord10.z - texCoord10.x );
				float temp_output_15_0 = saturate( temp_output_17_0 );
...
/*ASEBEGIN
Version=18912
1920;0;1920;1029;2228.137;275.4813;1;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;10;-1571,242.5;Inherit;False;1;-1;3;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleSubtractOpNode;17;-1173,178.5;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NormalVertexDataNode;19;-726,374.5;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;15;-646,180.5;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;-471,270.5;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-318,414.5;Inherit;False;Property;_PushPull;PushPull;5;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;9;-956,-122.5;Inherit;True;Property;_MainTexture;Main Texture;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;11;-1606,162.5;Inherit;False;Property;_Growth;Growth;3;0;Create;True;0;0;0;False;0;False;0.8;0;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;8;-543,-85.5;Inherit;False;MainColor;1;;1;eff4c11ecb7c49a48835fe7d21985ca2;0;1;31;COLOR;1,1,1,1;False;2;FLOAT3;0;FLOAT;10
Node;AmplifyShaderEditor.RangedFloatNode;16;264,422.5;Inherit;False;Property;_ClipThreshold;Clip Threshold;4;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-209,241.5;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.PowerNode;23;-965,166.5;Inherit;True;True;2;0;FLOAT;0;False;1;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;22;-189,176.5;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=D2DFEC60FD93A18B5EB850CD48AC0F6F20B5F8B1